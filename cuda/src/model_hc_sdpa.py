"""HC model with SDPA - PyTorch implementation.

Hyper-Connections with unconstrained residual mixing using SDPA attention.
...
class TinyLM_HC_SDPA(nn.Module):
    """Hyper-Connections variant with SDPA attention."""
