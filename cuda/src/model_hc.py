"""HC model - PyTorch implementation.

Hyper-Connections with unconstrained residual mixing.
Mirrors mlx/src/model_hc.py for correctness comparison.
"""
...
class TinyLM_HC(nn.Module):
    """Hyper-Connections variant with unconstrained residual mixing."""
    ...
    def __init__(
        ...
        # Unconstrained residual mixer (can amplify!)
        self.H_res = nn.ModuleList(
            [StreamMix(streams, mode="softplus") for _ in range(n_layers)]
        )
    ...
    def forward(self, tokens: torch.Tensor) -> torch.Tensor:
        ...
        for l, blk in enumerate(self.blocks):
            ...
            # Residual mixing (unconstrained - can amplify!)
